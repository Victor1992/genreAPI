...
router.put('/:id', async (req, res) => {
    ...
    if (!movie) return res.status(404).send("The course with given id is not availaible");
...
router.delete('/:id', async (req, res) => {
    ...
    if (!movie) return res.status(404).send("The course with given id is not found");
